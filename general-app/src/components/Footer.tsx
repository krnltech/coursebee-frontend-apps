  ...
  return (
    <footer className="md:pb-20 pt-40 pb-10 max-w mx-auto px-4">
        <div className="grid gap-10 grid-cols-1 md:grid-cols-3 w-full">
            <div>
                <img className="max-w-[112px] w-full" src="/images/coursebeeLogo.svg" alt="Coursebee" />
                <p className="text-dark-gray py-3">{t("Copyright")} ©COURSEBEE 2023</p>
                <div className="flex justify-start gap-7 p-1 md:pt-12">
                    <a href="" className="block hover:bg-bright-orange transition rounded"><img className="hover:invert"
            ...
            <div>
                ...
                <div className="grid grid-cols-2 justify-between">
                    ...
                    <a data-component="open-contact" className="footer-link cursor-pointer">{t("Contact")}</a>
