...
export const courses_bn = [
    ...
    },
    {
      ...
      price: '৪৯৯৯.৯৯',
      category: [categories.get('coding')?.bn],
      rating: 4.5,
    },
    {
      ...
      price: '৪৯৯৯.৯৯',
      category: [categories.get('job_based')?.bn, categories.get('quick_learn')?.bn],
      rating: 3,
    },
    {
      title: 'After-School',
    ...
    },
    {
      ...
      price: '৪৯৯৯.৯৯',
      category: [categories.get('coding')?.bn, categories.get('research')?.bn, categories.get('practical')?.bn],
      rating: 3.5,
    },
    {
      ...
      price: '৪৯৯৯.৯৯',
      category: [categories.get('quick_learn')?.bn, categories.get('enhancer')?.bn, categories.get('editorial')?.bn],
      rating: 0,
    },
  ]
  /**
  ...
  export const courses_en = [
    ...
    },
    {
      ...
      cover: '/images/courses/thumbnails/course-15.png',
      price: '4999.99',
      category: [categories.get('coding')?.en],
      rating: 4.5,
    },
    {
      title: 'Mastering English Communication',
      ...
      cover: '/images/courses/thumbnails/course-16.png',
      price: '4999.99',
      category: [categories.get('job_based')?.en, categories.get('quick_learn')?.en],
      rating: 3,
    },
    {
      title: 'After-School',
    ...
    },
    {
      ...
      cover: '/images/courses/thumbnails/course-17.png',
      price: '4999.99',
      category: [categories.get('coding')?.en, categories.get('research')?.en, categories.get('practical')?.en],
      rating: 3.5,
    },
    {
      title: 'Mastering Effective',
      ...
      cover: '/images/courses/thumbnails/course-18.png',
      price: '4999.99',
      category: [categories.get('quick_learn')?.en, categories.get('enhancer')?.en, categories.get('editorial')?.en],
      rating: 0,
    },
  ]
